...
An isometric 3D web game with character customization, built with:
...
**Key directories:** `src/components/three/` (R3F scene), `src/components/ui/` (overlay UI), `src/game/` (stores, constants, pathfinding), `src/types/` (shared types)
...
| `react-three-fiber` | R3F v9, Drei, Rapier, postprocessing |
